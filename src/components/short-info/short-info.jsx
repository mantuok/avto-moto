  ...
  return (
    <section className="main__short-info short-info">
      ...
      <ul className="short-info__short-features short-features">
        <li className="short-features__item">бензин</li>
        <li className="short-features__item">механика</li>
        <li className="short-features__item">100 л.с.</li>
        <li className="short-features__item">1.4 л</li>
      </ul>
